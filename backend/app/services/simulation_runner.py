    ...
    def start_simulation(
        ...
        try:
            ...
            if config.get("random_seed") is not None:
                # PYTHONHASHSEED must be present before the interpreter starts;
                # setting it inside the child process would be too late.
                env['PYTHONHASHSEED'] = str(config["random_seed"])
